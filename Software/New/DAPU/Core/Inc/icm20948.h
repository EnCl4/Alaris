...
/* User Configuration - DAPU: shared SPI1 sensor bus, CS on PE8 */
...
// Sensor init. Returns false if the device does not answer, instead of the
// original library behaviour of spinning forever in a while loop.
